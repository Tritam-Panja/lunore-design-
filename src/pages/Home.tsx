...
export function Home() {
  ...
  return (
    <div className="relative">
      {/* 1. HERO SECTION */}
      <section id="hero" className="relative flex flex-col items-center justify-center text-center px-6 pt-32 pb-24 md:pt-48 md:pb-36 min-h-[95vh] overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          <img
            src={images.heroBg}
            alt=""
            className="w-full h-full object-cover opacity-35 kenburns"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-[#1f2122]/70 via-[#1f2122]/60 to-[#1f2122]" />
        </div>
        
        {/* Subtle Ambient Radial Glow */}
        <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#c2a67e]/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          <div className="mt-12 flex justify-center hero-word" style={{ animationDelay: '1.5s' }}>
            <a href="#brand-story" className="inline-block w-5 h-8 border border-[#c2a67e]/60 rounded-full relative animate-bounce transition-colors hover:border-[#c2a67e]">
      ...
      <section id="brand-story" className="py-24 md:py-36 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <Reveal>
            ...
            <h2 className="text-3xl md:text-5xl font-light leading-tight">
              Spaces Are Not Just Designed. They Are Felt.
            </h2>
            <p className="mt-4 text-xs tracking-[0.2em] uppercase text-[#a3a3a3]">
          ...
          <Reveal delay={0.2} className="mt-12">
            <Link
              to="/brand-story"
              className="inline-flex items-center gap-3 px-8 py-4 border border-[#c2a67e] text-xs tracking-[0.3em] uppercase text-[#c2a67e] hover:bg-[#c2a67e] hover:text-[#1f2122] transition-all group shimmer"
            >
      ...
      <section id="about" className="py-24 md:py-36 relative">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <Reveal className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-light">Shaping Legacy From Stone</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {aboutPillars.map((p, i) => (
              <Reveal
                ...
                direction="up"
                delay={i * 0.1}
                className="hover-lift border border-[rgba(255,255,255,0.08)] bg-[#2a2c2d]/40 p-8 transition-colors hover:border-[#c2a67e]/40"
              >
                <p.icon className="w-8 h-8 text-[#c2a67e] mb-5" strokeWidth={1} />
          ...
          <div className="mt-16 text-center">
            <Reveal>
              <Link
                to="/about"
                className="inline-flex items-center gap-3 px-8 py-4 border border-[rgba(255,255,255,0.15)] text-xs tracking-[0.3em] uppercase text-[#f2f2f2] hover:border-[#c2a67e] hover:text-[#c2a67e] transition-all group"
              >
      ...
      <section id="services" className="py-24 md:py-36 relative">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <Reveal className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-light">Services &amp; Craft</h2>
            <p className="mt-6 text-lg text-[#a3a3a3] leading-relaxed font-light">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Reveal direction="left" className="p-8 md:p-12 border border-[rgba(255,255,255,0.1)] bg-[#2a2c2d]/30 flex flex-col justify-between hover-lift">
              <div>
                <div className="flex items-center justify-between mb-8">
                  <span className="text-xs tracking-[0.3em] uppercase text-[#c2a67e]">Full-Scope</span>
                  <Ruler className="w-8 h-8 text-[#c2a67e]" strokeWidth={1} />
                </div>
                <h3 className="text-2xl md:text-3xl font-light mb-4">Interior Design Solutions</h3>
                <p className="text-[#a3a3a3] leading-relaxed font-light mb-6">
                ...
                <ul className="space-y-2 mb-8">
                  {['Space Planning & Concepts', 'Turnkey Execution', 'Residential & Commercial'].map((item) => (
                    <li key={item} className="flex items-center gap-3 text-sm text-[#a3a3a3]">
                      <Check className="w-4 h-4 text-[#c2a67e]" />
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
              ...
              <Link
                to="/interior-design"
                className="inline-flex items-center gap-2 text-xs tracking-[0.25em] uppercase text-[#c2a67e] hover:underline mt-4 group"
              >
            ...
            <Reveal direction="right" className="p-8 md:p-12 border border-[rgba(255,255,255,0.1)] bg-[#2a2c2d]/30 flex flex-col justify-between hover-lift">
              <div>
                <div className="flex items-center justify-between mb-8">
                  <span className="text-xs tracking-[0.3em] uppercase text-[#c2a67e]">Curated Stones</span>
                  <Sparkles className="w-8 h-8 text-[#c2a67e]" strokeWidth={1} />
                </div>
                <h3 className="text-2xl md:text-3xl font-light mb-4">Marble &amp; Granite Solutions</h3>
                <p className="text-[#a3a3a3] leading-relaxed font-light mb-6">
      ...
      <section id="projects" className="py-24 md:py-36 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <Reveal className="flex flex-col md:flex-row items-start md:items-end justify-between mb-12">
            ...
            <Link
              to="/products"
              className="mt-4 md:mt-0 flex items-center gap-2 text-xs tracking-[0.2em] uppercase text-[#a3a3a3] hover:text-[#c2a67e] transition-colors group"
            >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <Reveal className="flex flex-col md:flex-row items-start md:items-end justify-between mb-10 border-t border-[rgba(255,255,255,0.08)] pt-12">
            <div>
              <p className="text-xs tracking-[0.3em] uppercase text-[#c2a67e] mb-2">
                Conceptual Works
              </p>
              <h3 className="text-2xl md:text-4xl font-light">Dream Projects</h3>
            </div>
            <Link
              to="/dream-project"
              className="mt-4 md:mt-0 flex items-center gap-2 text-xs tracking-[0.2em] uppercase text-[#a3a3a3] hover:text-[#c2a67e] transition-colors group"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {dreamConcepts.map((item, i) => (
              <Reveal key={item.title} direction="up" delay={i * 0.08}>
                ...
                <p className="text-xs tracking-[0.2em] uppercase text-[#a3a3a3] mt-1">{item.desc}</p>
              </Reveal>
            ))}
          </div>
        </div>
      ...
      <section id="process" className="py-24 md:py-36 relative">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <Reveal className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-light">Hand-Carved Excellence</h2>
            <p className="mt-6 text-lg text-[#a3a3a3] leading-relaxed font-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {processSteps.map((s, i) => (
              <Reveal key={s.num} direction="up" delay={i * 0.1} className="p-8 border border-[rgba(255,255,255,0.08)] bg-[#2a2c2d]/30 relative hover-lift">
                ...
                <div className="w-10 h-px bg-[#c2a67e]/60 mb-4" />
        ...
        <div className="max-w-3xl mx-auto px-6">
          <Reveal>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                to="/contact"
                className="px-8 py-4 border border-[rgba(255,255,255,0.15)] text-xs tracking-[0.3em] uppercase text-[#a3a3a3] hover:border-[#c2a67e] hover:text-[#c2a67e] transition-all inline-flex items-center justify-center"
              >
                Contact Page
              </Link>
            </div>
      ...
      <section id="contact" className="py-24 md:py-36 relative">
        <div className="max-w-6xl mx-auto px-6">
          <Reveal className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-light text-shimmer">Connect With The Studio</h2>
            <p className="mt-4 text-sm tracking-[0.25em] uppercase text-[#a3a3a3]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <Reveal direction="right" className="space-y-8 flex flex-col justify-between">
              ...
              <div className="pt-8 border-t border-[rgba(255,255,255,0.08)]">
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 text-xs tracking-[0.25em] uppercase text-[#c2a67e] hover:underline group"
                >
