...
export function BrandStory() {
  return (
    <div>
      <section className="relative px-6 pt-32 pb-16 md:pt-44 md:pb-20 text-center max-w-4xl mx-auto">
        <div className="absolute inset-0 overflow-hidden -z-10">
          <img src={images.brandStoryHero} alt="" className="w-full h-full object-cover opacity-20" />
      ...
      <section className="py-20 md:py-28 border-t border-[rgba(255,255,255,0.1)]">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-8">
            {paragraphs.map((p, i) => (
              <p key={i} className="text-lg text-[#a3a3a3] leading-relaxed font-light">
                {p}
              </p>
            ))}
          </div>
      ...
      <section className="py-20 md:py-28 border-t border-[rgba(255,255,255,0.1)] text-center">
        <Link
          to="/contact"
          className="px-8 py-4 border border-[#c2a67e] text-xs tracking-[0.3em] uppercase text-[#c2a67e] hover:bg-[#c2a67e] hover:text-[#1f2122] transition-all inline-flex items-center gap-2"
        >
