    ...
    <div>
      <section className="relative px-6 pt-32 pb-20 md:pt-44 md:pb-28 text-center max-w-4xl mx-auto">
        <div className="absolute inset-0 overflow-hidden -z-10">
          <img src={images.aboutHero} alt="" className="w-full h-full object-cover opacity-20" />
      ...
      <section className="py-20 md:py-28 border-t border-[rgba(255,255,255,0.1)] text-center">
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          <Link
            to="/products"
            className="px-8 py-4 border border-[#c2a67e] text-xs tracking-[0.3em] uppercase text-[#c2a67e] hover:bg-[#c2a67e] hover:text-[#1f2122] transition-all inline-flex items-center justify-center gap-2"
          >
